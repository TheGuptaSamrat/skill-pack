...
required_files=(
  ...
  "$repo_root/skills/cvpm/references/cvpm-build-sequence-guide.md"
  ...
  "$repo_root/implementation/README.md"
  "$repo_root/implementation/rdl-net-posting-autopilot/rdl-net-posting-implementation-pack.md"
  "$repo_root/implementation/rdl-net-posting-autopilot/design/netting-join-logic.md"
  "$repo_root/implementation/rdl-net-posting-autopilot/examples/zero-shot.md"
  "$repo_root/implementation/rdl-net-posting-autopilot/examples/one-shot.md"
