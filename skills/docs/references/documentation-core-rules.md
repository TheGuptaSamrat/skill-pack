...
- prefer metadata evidence over free-form assumptions whenever both exist
- use source-system onboarding context only when it changes the technical interpretation
